...
const Projects = () => {
  return (
    <div id="projetos" className="2xl:h-[95vh] lg:py-12 py-8 flex flex-col items-center gap-y-10 lg:gap-y-14 2xl:gap-y-20 bg-fiveGreen">
        ...
        <div className="2xl:px-60 xl:px-20 w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 place-items-center">
          ...
          <ProjectsCard image={site02} title="Site Institucional Moral Asessoria" text="Site Institucional feito para o escritório de contabilidade Moral Asessoria Contábil." languagesIcons={[1,2,3,4]} website="https://moralassessoria.com.br/"/>
