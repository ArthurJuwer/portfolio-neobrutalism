const MainTitle = () => {
  return (
    <div className="flex items-center lg:items-start flex-col gap-6">
        ...
        <p className="text-textGray lg:text-lg text-base font-medium w-10/12 lg:w-[65%] text-center lg:text-left">Atualmente estou no 2° ano do ensino médio integrado ao técnico em T.I. Confira minha caminhada e me conheça.</p>
