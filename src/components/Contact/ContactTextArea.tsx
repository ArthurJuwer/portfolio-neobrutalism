  ...
  return (
    <div className="relative w-96">
        ...
        <textarea 
          ...
          value={value}
          onChange={onChange}
          className="resize-none outline-none z-0 border-neoBrutalism shadow-neoBrutalism_350 bg-mainGreen p-4 w-full font-semibold placeholder:text-gray-500 rounded-sm h-36" 
          />
    </div>
  )
}
