...
const Contact = () => {
  return (
    <div id="contato" className="bg-secondBackground p-12 border-neoBrutalism shadow-neoBrutalism flex flex-col items-center justify-start gap-y-14 ">
        ...
        <div className="flex flex-col gap-y-12">
            ...
            <ContactTextArea />
            <button className="border-neoBrutalism shadow-neoBrutalism py-3 font-semibold text-lg rounded-sm">Enviar</button>
        </div>
