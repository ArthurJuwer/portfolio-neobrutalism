  ...
  return (
    <div  className=" relative bg-mainBackground h-[65vh]">
        ...
        <div className="absolute -translate-x-1/2 left-1/2 top-0 z-50 w-9/12 flex flex-col justify-center">
            ...
            <div className="-mt-6 w-full flex justify-between py-12 px-28 bg-secondGreen text-center rounded-b-2xl border-2 border-t-0 border-black shadow-neoBrutalism">
                
                <SocialMediaCard icon={<Github size={70} />} link="github.com/ArthurJuwer" followers="14 seguidores"/>
                <SocialMediaCard icon={<Linkedin size={70} />} link="linkedin/in/arthurjuwer" followers="165 conexões"/>
